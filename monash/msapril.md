...
The two Palestine motions are item N motion 14 and item O motion 15 of the [final agenda](https://drive.google.com/file/d/1EMxThZYIgooqxaudnExFPjwxb3aemfjs/view?usp=sharing). Below are the bodies of the motions - the preambles can be read in the agenda.
...
Before the SAlt/SfP motion could be considered, Lana moved a produral to "foreshadow" it. The [MSC Standing Orders](https://msa.monash.edu/hubfs/Governance%20Docs/Consti%20+%20Regs/MSC%20Standing%20Orders.pdf) provide that
...
> - If a foreshadowed motion is passed, the motion it is foreshadowing lapses unless the Chair rules that that motion and the foreshadowed motion are not mutually exclusive.
...
<iframe data-testid="embed-iframe" style="border-radius:12px" src="https://open.spotify.com/embed/episode/0ILIMEFBAZIuPMIErL4fK2/video?utm_source=generator&t=617" width="624" height="351" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
